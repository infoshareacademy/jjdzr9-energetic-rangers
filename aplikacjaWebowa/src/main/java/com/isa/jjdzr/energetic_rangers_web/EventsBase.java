...
public class EventsBase {
   ...
   //uploadEvents - metoda do zwracania eventów
    ...
    private static List<EventsItem> createEvents () {
        ...
        EventsItem event3 = new EventsItem("1232", "Zła macocha", 122, 450.00, "https://static.prsa.pl/images/37897055-3107-4c3b-bb60-eb3a1ef30df3.file?format=700", "Dla dzieci", "Gdańsk", "22-05-2023r", "Przepiękna historia o ubogiej dziewczynce której macocha nienawidziła","16","4","2023");
